...
import com.zc.fn.Fn;
import com.zc.jdbc.NameConvert;
...
public class Utils {
   ...
   * @return 名称，一般用于列名
   */
  public static <T> String convertEntityField(Fn<T, Object> fieldFn) {
    return NameConvert.getInstance().convertEntityField(fieldFn);
  }
   ...
   * @return 名称，一般用于列名
   */
  public static <T> String convertEntityField(String field) {
    return NameConvert.getInstance().convert(field);
  }
}
